    ...
    return (
        ...
        <div class="history-section">
            ...
            <div class="history-content">
                ...
                <h2 class="titleh2_light">Carreira Acadêmica e Contribuições Científicas</h2>
                <p class="p_light">O seu passo seguinte foi rumo à Universidade de Göttingen, que era na altura um dos centros mais reconhecidos no campo da física teórica da Europa, onde conviveu com alguns dos físicos mais notáveis da época, como Niels Bohr e Paul Dirac, e onde fez importantes contributos para o então recente campo da física quântica, concluindo o seu doutoramento aos 22 anos.</p>
                <img src="/src/assets/imagens/historia/3.jpg" alt="Imagem do Projeto Manhattan" class="history-img"/>
                <p class="p_light">Regressou aos Estados Unidos da América, e à Universidade de Harvard, em 1927. Apenas um ano mais tarde, iniciou a sua carreira como docente no Instituto Tecnológico da Califórnia – Cal Tech – e na Universidade da Califórnia, em Berkeley.</p>
                <p class="p_light">As primeiras investigações de Oppenheimer focaram-se nos processos energéticos das partículas subatómicas, incluindo electrões, positrões e raios cósmicos. Também realizou trabalhos inovadores sobre estrelas de neutrões e buracos negros, espectroscopia e teoria quântica de campos. Além dos seus feitos académicos, Oppenheimer foi responsável pela excepcional formação de uma geração de físicos norte-americanos, que foram motivados pelas suas qualidades de liderança e independência intelectual.</p>

                <h2 class="titleh2_light">Da Ciência à Política e Vice-Versa: O Projeto Manhattan</h2>
                <p class="p_light">A vida de Oppenheimer, como a de muitas personagens do seu tempo, foi fortemente marcada pelo contexto político. Devido à sua ascendência alemã, o seu primeiro interesse pela política foi motivado pela subida de Hitler ao poder na Alemanha em 1936. <strong>Em 1937, com o falecimento do pai, Oppenheimer herdou uma fortuna que destinou em parte a apoiar a facção republicana da Guerra Civil Espanhola. Foi uma época em que Oppenheimer namoriscou com o comunismo e que viria a condicionar o seu futuro. Contudo, rapidamente renegou esses ideais ao ver a forma como Estaline tratou muitos dos seus colegas de profissão russos, que acabaram em gulags e sharashkas soviéticos.</strong></p>
                <p class="p_light">Após a invasão da Polónia, em 1939, surgiu entre cientistas como Oppenheimer, Albert Einstein, Leo Szilard e Eugene Wigner, entre outros, a necessidade de inventar a bomba atómica antes dos nazis, que já tinham dado rédea solta ao desenvolvimento do Projecto Urânio com essa finalidade.</p>
                <p class="p_light">Neste contexto, não foi difícil reunir algumas das mentes mais privilegiadas dos EUA e da Europa, as quais, correndo contra os alemães para construir a primeira bomba atómica, se reuniram em torno do Projecto Manhattan, pondo-se ao serviço de Oppenheimer, nomeado director científico do projecto, apesar das reticências de diversos comandantes do Pentágono devido às suas anteriores ligações esquerdistas.</p>
                <p class="p_light">Com efeito, ao longo dos anos seguintes, Oppenheimer foi constantemente investigado pelo FBI e pelo departamento de segurança interna do Projecto Manhattan. Não obstante, devido ao seu papel essencial e imprescindível durante todo o projecto, nunca foi destituído do cargo.</p>

                <img src="/src/assets/imagens/historia/4.jpg" alt="Imagem do Projeto Manhattan" class="history-img"/>

                <h2 class="titleh2_light">As Mãos Manchadas de Sangue</h2>
                <p class="p_light">O Projecto Manhattan alcançou a sua meta no dia 16 de Julho de 1945, com a experiência Trinity, que teve lugar nas proximidades de Álamo Gordo, no Novo México. Uma vez desenvolvida a bomba nuclear, muitos cientistas que participaram no projecto manifestaram relutância quanto à sua utilização, sobretudo contra a população civil.</p>
                <p class="p_light">Posteriormente, entre 1947 e 1952, Oppenheimer passou a ocupar o cargo de presidente do Comité de Assessoria Geral (GAC) da Comissão de Energia Atómica dos Estados Unidos da América (AEC), no qual se opôs ao desenvolvimento da bomba de hidrogénio. Embora, no início e no contexto da guerra, essa não fosse a posição inicial de Oppenheimer, poucos meses mais tarde, em Outubro desse mesmo ano, o físico, que declarou numa entrevista com o Presidente Harry S. Truman ter “as mãos manchadas de sangue”, renunciou ao seu cargo como director do Projecto Manhattan, dando a entender estar arrependido por nele ter participado.</p>
                <p class="p_light">Enquanto foi conselheiro político do GAC – e devido às dúvidas que o rodeavam por simpatizar com os comunistas – Oppenheimer fez muitos inimigos, sobretudo no FBI, então dirigido por J. Edgar Hoover.</p>
                <p class="p_light">Em 1953, Hoover acusou Oppenheimer de representar um risco para a segurança e o presidente dos EUA, Dwight David Eisenhower, pediu-lhe a demissão. Perante a sua recusa em demitir-se, foi pedida uma audiência de segurança na qual, embora tenha sido declarado inocente de traição, foi determinado que não deveria ter acesso a segredos militares.</p>
                <p class="p_light">Consequentemente, e embora a Federação de Cientistas dos EUA tenha saído imediatamente em sua defesa, o seu contrato como assessor da Comissão de Energia Atómica foi rescindido. A sua perseguição é hoje considerada uma caça às bruxas e a grande maioria dos historiadores considera Oppenheimer um liberal heterodoxo injustamente atacado.</p>
